...
// SaveRefreshToken saves a refresh token to Redis with a TTL.
...
func (r *TokenRepository) GetRefreshToken(userID uint) (*models.RefreshToken, error) {
	...
	// Deserialize JSON into RefreshToken struct
...
// ValidateRefreshToken checks if a refresh token exists and matches the hash.
